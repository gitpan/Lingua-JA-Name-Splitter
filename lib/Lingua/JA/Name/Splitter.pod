...
This splits the name using some heuristics. At the time of writing,
this module has not been tested extensively, so the heuristics will be
subject to change as more data is received.
...
name using the spaces, capitalization and commas in the name.
